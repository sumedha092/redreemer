export default function SecurityPanel() {
  return (
    <div className="bg-navy-800 border border-navy-600 rounded-xl p-5">
      ...
      <div className="space-y-3 text-xs text-navy-300 leading-relaxed">
        <div>
          <p className="text-white font-medium mb-1">What Redreemer stores</p>
          <p>Name, phone number, step progress, and conversation history — only what's needed to help each person move forward.</p>
        </div>
        <div>
          <p className="text-white font-medium mb-1">What Redreemer never does</p>
        ...
        <div>
          <p className="text-white font-medium mb-1">How data is protected</p>
