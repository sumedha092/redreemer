 ...
 * Fixes ngrok + browser CORS (OPTIONS preflight gets HTML from ngrok without CORS headers).
 *
 * Vercel: API_UPSTREAM_ORIGIN=https://YOUR.ngrok-free.dev (no trailing slash)
 * Vercel: VITE_API_URL=/api/p (Production)
 */
  ...
  if (request.method === 'OPTIONS') {
    ...
    return new Response(null, {
      ...
      headers: {
        ...
        'Access-Control-Allow-Headers': reqHdr.includes('authorization')
